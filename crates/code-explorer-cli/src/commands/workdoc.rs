...
fn build_work_question_prompt(
    ...
    [
        ...
        "- Si la question demande \"tous\", \"toutes\", \"exhaustif\", \"écrans\", \"lettres\", \"flux\" ou \"où se trouve\", ajoute une cartographie par canal : écran/vue, contrôleur, service, calcul métier, document/lettre, flux ou batch, et indique clairement les recherches sans résultat.".to_string(),
