...
//! ```json
//! {
//!   "question": "Explain the CasesController",
//!   "repo": "sample-app",
//!   "history": [
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Id="rIdDocument" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="word/document.xml"/>
    ...
    fn workdoc_question_parser_detects_common_shapes() {
        assert_eq!(
            parse_workdoc_question_line("Q1.1 — Paramétrage Création Groupe de Produits"),
            Some((
                "Q1.1".to_string(),
                "Paramétrage Création Groupe de Produits".to_string()
            ))
        );
        assert_eq!(
    ...
    fn workdoc_extraction_deduplicates_questions_and_keeps_context() {
        let markdown = r#"
# Atelier
Q1.1 — Paramétrage Création Groupe de Produits
...
# Atelier Sample
Q1.1
Paramétrage Création Groupe de Produits
Contexte métier important.
...
"#;
        ...
        assert_eq!(questions[0].label, "Q1.1");
        assert_eq!(questions[0].text, "Paramétrage Création Groupe de Produits");
        assert!(questions[0].context.contains("Contexte métier important"));
