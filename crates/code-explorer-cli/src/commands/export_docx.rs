...
mod tests {
    ...
    fn wide_narrative_tables_are_rendered_as_readable_cards() {
        let lines = [
            ...
            "|---|---|---|---:|---:|",
            "| 1 | Mais le plus petit taux provient d’une grille tarifaire ? Donc comme il n’y a jusqu’ici qu’une seule grille par groupe, cette règle de Min ne s’applique jamais ? | Répondue | 7 | 1 |",
        ];
