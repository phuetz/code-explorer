...
fn render_code_explorer_agent_skill(
    ...
    md.push_str("- Symbol context: `code-explorer context LetterController`\n");
    md.push_str("- Impact: `code-explorer impact LetterController --direction both`\n");
    md.push_str("- Related files: `code-explorer trace-files LetterController --depth 3 --json`\n");
    md.push_str("- Diagram: `code-explorer diagram LetterController --type flowchart`\n");
