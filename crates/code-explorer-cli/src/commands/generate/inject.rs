//! `code-explorer generate inject` — inject fragments into existing documentation pages.
//!
...
//!   "fragments": [
//!     {
//!       "page": "modules/pricing",
//!       "anchor": "GNX:IMAGE:schema",
//!       "type": "image",
//!       "source": "docs/assets/schema.png",
//!       "alt": "Schéma calcul tarifs"
//!     },
//!     {
//!       "page": "modules/extledger",
...
#[derive(Debug, Deserialize)]
pub struct Fragment {
    /// Relative page id, e.g. "modules/pricing" or "architecture"
    pub page: String,
...
fn resolve_page(docs_dir: &Path, page: &str) -> PathBuf {
    // page is relative to docs_dir, e.g. "modules/pricing" → .../modules/pricing.md
