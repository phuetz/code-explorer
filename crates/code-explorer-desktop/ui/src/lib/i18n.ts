// ─── Code Explorer i18n — Lightweight translation system ───
...
const en = {
  ...
  "repos.onboarding.step2.desc": "Code Explorer scans your files, resolves imports, and builds a knowledge graph.",
  ...
  "a11y.codeIntelligencePlatform": "Code Explorer — Code Intelligence Platform",
...
const fr: Record<keyof typeof en, TranslationValue> = {
  ...
  "chat.welcomeValue":
    "Code Explorer donne à ce chat tout votre code sous forme de graphe — des réponses précises pour une fraction du contexte.",
  ...
  "repos.onboarding.step2.desc": "Code Explorer scanne vos fichiers, résout les imports et construit un graphe de connaissances.",
  ...
  "a11y.codeIntelligencePlatform": "Code Explorer — Plateforme d'intelligence de code",
...
function detectDefaultLocale(): Locale {
  if (typeof localStorage !== "undefined") {
    const saved = localStorage.getItem("code-explorer-locale") as Locale | null;
...
export function setLocale(locale: Locale) {
  ...
  if (typeof localStorage !== "undefined") {
    localStorage.setItem("code-explorer-locale", locale);
  }
