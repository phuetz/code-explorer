...
mod tests {
    use super::*;
    use code_explorer_core::graph::types::{GraphRelationship, NodeProperties};
    ...
    fn build_skeleton_flowchart_generates_valid_mermaid_nodes() {
        let class_id = "Class:src/Lettre.cs:Lettre";
        let method_id = "Method:src/Lettre.cs:BuildMessage";
        let callee_id = "Method:src/Lettre.cs:SaveMessage";
        ...
        assert!(mermaid.contains("Lettre"));
