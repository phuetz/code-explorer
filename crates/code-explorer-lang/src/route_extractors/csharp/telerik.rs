...
@(Html.Telerik().Grid<Export>()
    ...
    .DataBinding(dataBinding => dataBinding.Ajax()
        .Select("GetExportLedgerGrid", "Factures"))
    .Columns(columns => {
...
"#;
        ...
        // DataSource: .Select("GetExportLedgerGrid", "Factures") -> Read action
        assert_eq!(grid.data_source_actions.len(), 1);
        assert_eq!(grid.data_source_actions[0].operation, "Read");
        assert_eq!(
