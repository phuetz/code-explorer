...
"#;
    ...
    fn test_extract_ajax_getjson() {
        let source = r#"
$.getJSON('/Cases/AfficherProduits', { id: caseId }, function(data) {
...
"#;
        ...
        let call = &calls[0];
        assert_eq!(call.method, "GET");
        assert_eq!(call.controller_name.as_deref(), Some("Cases"));
        assert_eq!(call.action_name.as_deref(), Some("AfficherProduits"));
    }
