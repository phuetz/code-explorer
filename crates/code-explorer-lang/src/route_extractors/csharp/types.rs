...
pub struct PartialReference {
    /// The partial view or action name (e.g., "_VueGroupeProduits")
...
pub struct TracingInfo {
    /// Whether this file has any TraceLogger/tracing calls
    pub is_traced: bool,
    /// Number of TraceLogger method calls (Info, Error, Warning, etc. -- NOT BeginMethodScope)
    pub call_count: u32,
...
pub struct ExternalServiceCall {
    ...
    pub service_type: String,
    /// Client class name (e.g., "AcmeClient", "PartnerClient")
    pub client_class: String,
    /// Method called (e.g., "CustomersGetAsync")
