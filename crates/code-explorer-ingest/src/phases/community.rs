...
fn louvain_communities(
    ...
    for _iteration in 0..max_iterations {
        ...
        for i in 0..n {
            ...
            let mut neighbor_community_edges: BTreeMap<usize, f64> = BTreeMap::new();
...
mod tests {
    ...
    #[test]
    fn communities_are_repeatable_with_tied_gains_and_labels() {
        ...
        for _ in 0..32 {
            ...
            for (a, b) in [("a", "b"), ("b", "c"), ("c", "d"), ("d", "a")] {
                graph.add_relationship(make_calls_edge(a, b));
            }
            detect_communities(&mut graph).unwrap();
