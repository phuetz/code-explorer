...
describe('WorkspacePanel', () => {
  ...
  it('highlights related files in the file tree', async () => {
    render(
      <WorkspacePanel
        onClose={() => {}}
        highlightedSourcePaths={['Controllers/CourrierController.cs']}
      />
    );
  ...
  it('shows a related files navigator and exports an analysis pack', async () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: /Controllers\/CourrierController\.cs/i }));
    ...
    render(
      <WorkspacePanel
        ...
        relatedSourceGroups={[
          {
            path: 'Controllers/CourrierController.cs',
            references: [{ path: 'Controllers/CourrierController.cs', startLine: 42 }],
          },
          {
            path: 'Models/Autre.cs',
          ...
          messages: [
            {
              ...
              role: 'assistant',
              content:
                'Voir Controllers/CourrierController.cs:42 et ```mermaid\ngraph TD\nA-->B\n```',
              createdAt: 2000,
