...
const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  {
    id: 'tailnet-host',
    label: 'TAILNET-HOST Ollama',
    badge: '2x3090',
    privacy: 'Inference locale sur TAILNET-HOST via Tailscale, ideale pour les gros modeles.',
  ...
  {
    id: 'workstation-linux',
    label: 'Workstation Linux Ollama',
    badge: 'Hub',
    privacy: 'Provider local reseau pour le serveur always-on, quand Ollama y est expose.',
    provider: 'workstation-linux-ollama',
    baseUrl: 'http://100.64.0.11:11434/v1',
    model: '',
    reasoningEffort: 'none',
    maxTokens: 8192,
    requiresKey: false,
    probeAvailability: true,
    tailnetHostName: 'workstation-linux',
  },
  {
    id: 'lm-studio',
