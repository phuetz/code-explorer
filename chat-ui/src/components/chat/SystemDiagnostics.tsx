    ...
    <div className="space-y-3">
      ...
      {activeRepoMissing && (
        <div className="rounded-md border border-amber-900/60 bg-amber-950/20 px-3 py-2 text-amber-200">
          ...
          backend avec <code className="rounded bg-neutral-900 px-1">.\code-explorer.cmd chat -RestartBackend</code>.
        </div>
      )}
