...
describe('chat-store persistence', () => {
          ...
          analyses: [
            {
              ...
              updatedAt: '3600',
              sourceReferences: [
                { path: 'Controllers\\LetterController.cs', startLine: '42', endLine: '44' },
                { path: 'Controllers/LetterController.cs', startLine: 42, endLine: 44 },
                { path: '', startLine: 1 },
                null,
              ],
      ...
      sessions: [
        {
          ...
          updatedAt: 2000,
          messages: [
            { id: 'm1', role: 'user', content: 'Explique TraceLogger', createdAt: 1000 },
  ...
  it('saves, updates, caps, and deletes analysis snapshots on sessions', () => {
    ...
    useChatStore.getState().saveAnalysisSnapshot('s1', {
      ...
      createdAt: 9000,
      updatedAt: 9000,
      sourceReferences: [{ path: 'Controllers/LetterController.cs', startLine: 42 }],
      summary: {
        fileCount: 1,
        diagramCount: 1,
        toolCallCount: 2,
